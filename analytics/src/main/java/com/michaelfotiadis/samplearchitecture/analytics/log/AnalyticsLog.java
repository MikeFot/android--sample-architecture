package com.michaelfotiadis.samplearchitecture.analytics.log;

import android.util.Log;

import com.michaelfotiadis.samplearchitecture.analytics.BuildConfig;
...
public final class AnalyticsLog {
    ...
    private static Set<String> getEscapedClassNames() {
        ...
        set.add(AnalyticsLog.class.getName());
